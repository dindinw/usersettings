...
function main(){
    ...
    TYPE=Ubuntu_64
    INSTALLER="/d/ISO/ubuntu/12.04/ubuntu-12.04.4-server-amd64.iso"
    GUESTADDITIONS="/c/Program Files/Oracle/VirtualBox/VBoxGuestAdditions.iso"
    KS_CFG="ubuntu-12.04.4-server-amd64.preseed.cfg"
    main_template
}

function create_pxecfg_ubuntu-12.04.4-server-amd64() {
