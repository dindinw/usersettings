...
#x86
#1installvm_path="/D/ISO/windows/win81/win81_wim_x86"
...
#vhd_file="${HOME}/Downloads/win81_x86.vhd"

installvm_path="/D/ISO/windows/win81/win81_wim_x64"
win81_iso_path="/d/ISO/windows/win81/9600.17050.WINBLUE_REFRESH.140317-1640_X64FRE_ENTERPRISE_EVAL_EN-US-IR3_CENA_X64FREE_EN-US_DV9.ISO"


vhd_file="${HOME}/Downloads/win81_x64.vhd"
vhd_letter="v:"
